export const USERS_MESSAGES = {
  ...
  PASSWORD_LENGTH_MUST_BE_6_TO_100: 'Password length must be between 6 and 100 characters',
  PASSWORD_MUST_BE_STRONG:
    'Password must be 6-100 characters long and contain at least one uppercase letter, one lowercase letter, one number, and one special character',
  CONFIRM_PASSWORD_IS_REQUIRED: 'Confirm password is required',
  CONFIRM_PASSWORD_MUST_BE_STRING: 'Confirm password must be string',
  CONFIRM_PASSWORD_LENGTH_MUST_BE_6_TO_100: 'Confirm password length must be between 6 and 100 characters',
